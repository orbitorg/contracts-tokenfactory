...
fn bonding() {
    ...
    // Calculate rebalancing amounts based on target allocations
    let total_bonded = Uint128::new(1012043);
    // let alice_target = total_bonded.multiply_ratio(60u128, 100u128); // 60%
    // let bob_target = total_bonded.multiply_ratio(40u128, 100u128); // 40%
